      ...
      {category === 'Custom' && (
        <div className="mt-3 animate-fadeIn">
          <div className="relative">
            <Edit3 className="w-4 h-4 text-[#d97757] absolute left-3.5 top-1/2 -translate-y-1/2" />
            <input
              type="text"
              value={customNiche}
              onChange={(e) => setCustomNiche(e.target.value)}
              placeholder="Enter custom niche (e.g. Solana, Fashion, Real Estate)..."
              className="w-full bg-white/[0.05] border border-white/10 rounded-2xl p-3 pl-10 text-xs font-medium text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-[#d97757]"
            />
          </div>
